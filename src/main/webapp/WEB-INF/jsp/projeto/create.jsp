    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 ">
            <div class="panel panel-primary">
                <div class="panel-heading"><h3>Novo Projeto</h3></div>
                    ...
                    <form  id="criar-projeto" method="post" modelAttribute="projeto">
                        ...
                        <fieldset class="form-group">
                            <div class="mb-3">
                                ...
                                <textarea name="descricao" type="text" class="form-control" required="required"></textarea>
                            </div>
                        </fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="gerente.id" class="form-select" aria-label="Default select example">
                                    ...
                                    <c:forEach var="gerente" items="${gerentes}">
                                        <option value="${gerente.id}">${gerente.getNome()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="date" name="dataPrevisaoFim" class="form-control" id="dataPrevisaoFim"  >
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="form-group">
                            <div class="mb-3">
                                ...
                                <input name="orcamento" type="text" class="form-control" required="required" />
                            </div>
                        </fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select" aria-label="Default select example">
                                    ...
                                    <c:forEach var="status" items="${statusList}">
                                        <option value="${status.name()}">${status.displayValue()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="risco" class="form-select" aria-label="Default select example">
                                    ...
                                    <c:forEach var="risco" items="${riscoList}">
                                        <option value="${risco.name()}">${risco.displayValue()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </fieldset>
